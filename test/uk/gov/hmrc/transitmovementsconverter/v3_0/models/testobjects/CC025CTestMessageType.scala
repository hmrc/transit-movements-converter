...
object CC025CTestMessageType extends TestMessageType {
  ...
  lazy val json1 = Json.parse(
    """{"n1:CC025C":{"messageSender":"token","messageRecipient":"token","preparationDateAndTime":"2007-10-26T07:36:28","messageIdentification":"token","messageType":"CC025C","correlationIdentifier":"token","TransitOperation":{"MRN":"string","releaseDate":"2014-06-09+01:00","releaseIndicator":"token"},"CustomsOfficeOfDestinationActual":{"referenceNumber":"stringst"},"TraderAtDestination":{"identificationNumber":"string"},"Consignment":{"HouseConsignment":[{"sequenceNumber":100,"releaseType":"token","ConsignmentItem":[{"goodsItemNumber":100,"declarationGoodsItemNumber":100,"releaseType":"token","Commodity":{"descriptionOfGoods":"string","cusCode":"token","CommodityCode":{"harmonizedSystemSubHeadingCode":"token","combinedNomenclatureCode":"st"},"DangerousGoods":[{"sequenceNumber":100,"UNNumber":"token"}],"GoodsMeasure":{"grossMass":10}},"Packaging":[{"sequenceNumber":100,"typeOfPackages":"token","numberOfPackages":100,"shippingMarks":"string"}]}]}]},"@PhaseID":"NCTS5.0"}}"""
  )
