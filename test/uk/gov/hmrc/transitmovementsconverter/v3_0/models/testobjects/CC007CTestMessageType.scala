...
object CC007CTestMessageType extends TestMessageType {
  ...
  lazy val json1 = Json.parse(
    """{"n1:CC007C":{"messageSender":"token","messageRecipient":"token","preparationDateAndTime":"2007-10-26T07:36:28","messageIdentification":"token","messageType":"CC007C","correlationIdentifier":"token","TransitOperation":{"MRN":"string","arrivalNotificationDateAndTime":"2014-06-09T16:15:04+01:00","simplifiedProcedure":"1"},"Authorisation":[{"sequenceNumber":100,"referenceNumber":"string","type":"token"}],"CustomsOfficeOfDestinationActual":{"referenceNumber":"stringst"},"TraderAtDestination":{"identificationNumber":"string","communicationLanguageAtDestination":"token"},"Consignment":{"LocationOfGoods":{"typeOfLocation":"token","qualifierOfIdentification":"token","authorisationNumber":"string","additionalIdentifier":"stri","UNLocode":"token","CustomsOffice":{"referenceNumber":"stringst"},"GNSS":{"latitude":"string","longitude":"string"},"EconomicOperator":{"identificationNumber":"string"},"Address":{"streetAndNumber":"string","postcode":"string","city":"string","country":"st"},"PostcodeAddress":{"houseNumber":"string","postcode":"string","country":"st"},"ContactPerson":{"name":"string","phoneNumber":"token","eMailAddress":"string"}}},"@PhaseID":"NCTS5.0"}}"""
  )
