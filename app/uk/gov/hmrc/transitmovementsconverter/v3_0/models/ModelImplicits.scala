...
object ModelImplicits {
  ...
  implicit lazy val transportChargesType02: OFormat[TransportChargesType02] = Json.format[TransportChargesType02]
  implicit lazy val commodityType10: OFormat[CommodityType10]               = Json.format[CommodityType10]
  implicit lazy val consignorType14: OFormat[ConsignorType14]               = Json.format[ConsignorType14]
  implicit lazy val consigneeType06: OFormat[ConsigneeType06]               = Json.format[ConsigneeType06]
  implicit lazy val placeOfUnloadingType: OFormat[PlaceOfUnloadingType]     = Json.format[PlaceOfUnloadingType]

  implicit lazy val consignmentItemType14: OFormat[ConsignmentItemType14] = Json.format[ConsignmentItemType14]
  implicit lazy val consignmentItemType10: OFormat[ConsignmentItemType10] = Json.format[ConsignmentItemType10]
  implicit lazy val locationOfGoodsType04: OFormat[LocationOfGoodsType04] = Json.format[LocationOfGoodsType04]
  implicit lazy val consignorType13: OFormat[ConsignorType13]             = Json.format[ConsignorType13]

  implicit lazy val carrierType06: OFormat[CarrierType06]                   = Json.format[CarrierType06]
  implicit lazy val houseConsignmentType17: OFormat[HouseConsignmentType17] = Json.format[HouseConsignmentType17]
  implicit lazy val houseConsignmentType13: OFormat[HouseConsignmentType13] = Json.format[HouseConsignmentType13]

  implicit lazy val transportMeansType: OFormat[TransportMeansType]         = Json.format[TransportMeansType]
  implicit lazy val transportChargesType01: OFormat[TransportChargesType01] = Json.format[TransportChargesType01]
  implicit lazy val previousDocumentType05: OFormat[PreviousDocumentType05] = Json.format[PreviousDocumentType05]

  implicit lazy val addressType21: OFormat[AddressType21]                                             = Json.format[AddressType21]
  implicit lazy val addressType22: OFormat[AddressType22]                                             = Json.format[AddressType22]
  ...
  implicit lazy val consignorType10: OFormat[ConsignorType10]                                         = Json.format[ConsignorType10]
  implicit lazy val goodsReferenceType03: OFormat[GoodsReferenceType03]                               = Json.format[GoodsReferenceType03]
  implicit lazy val addressType06: OFormat[AddressType06]                                             = Json.format[AddressType06]
  implicit lazy val transhipmentType: OFormat[TranshipmentType]                                       = Json.format[TranshipmentType]
  ...
  implicit lazy val placeOfLoadingType: OFormat[PlaceOfLoadingType]                                   = Json.format[PlaceOfLoadingType]
  ...
  implicit lazy val additionalSupplyChainActorType01Format: OFormat[AdditionalSupplyChainActorType01] = Json.format[AdditionalSupplyChainActorType01]
  ...
  implicit lazy val postcodeAddressTypeFormat: OFormat[PostcodeAddressType]                           = Json.format[PostcodeAddressType]
  implicit lazy val locationTypeFormatLocationTypeFormat: OFormat[LocationType]                       = Json.format[LocationType]
  implicit lazy val addressType19Format: OFormat[AddressType19]                                       = Json.format[AddressType19]
  implicit lazy val guaranteeReferenceType14Format: OFormat[GuaranteeReferenceType14]                 = Json.format[GuaranteeReferenceType14]
  ...
  implicit lazy val transportEquipmentType04Format: OFormat[TransportEquipmentType04]                 = Json.format[TransportEquipmentType04]
  ...
  implicit lazy val incidentType02Format: OFormat[IncidentType02]                                     = Json.format[IncidentType02]
  ...
  implicit lazy val guaranteeReferenceType07: OFormat[GuaranteeReferenceType07]                             = Json.format[GuaranteeReferenceType07]
  ...
  implicit lazy val functionalErrorType07Format: OFormat[FunctionalErrorType07]                             = Json.format[FunctionalErrorType07]
  implicit lazy val functionalErrorType08Format: OFormat[FunctionalErrorType08]                             = Json.format[FunctionalErrorType08]
  ...
  implicit lazy val transitOperationType49Format: OFormat[TransitOperationType49]                           = Json.format[TransitOperationType49]
  implicit lazy val transitOperationType50Format: OFormat[TransitOperationType50]                           = Json.format[TransitOperationType50]
  implicit lazy val transitOperationType55Format: OFormat[TransitOperationType55]                           = Json.format[TransitOperationType55]
  implicit lazy val transitOperationType56Format: OFormat[TransitOperationType56]                           = Json.format[TransitOperationType56]
  implicit lazy val transitOperationType57Format: OFormat[TransitOperationType57]                           = Json.format[TransitOperationType57]
  implicit lazy val transitOperationType58Format: OFormat[TransitOperationType58]                           = Json.format[TransitOperationType58]
  implicit lazy val transitOperationType60Format: OFormat[TransitOperationType60]                           = Json.format[TransitOperationType60]
  ...
  implicit lazy val customsOfficeOfDepartureType05Format: OFormat[CustomsOfficeOfDepartureType05] = Json.format[CustomsOfficeOfDepartureType05]
  ...
  implicit lazy val customsOfficeOfTransitDeclaredType06Format: OFormat[CustomsOfficeOfTransitDeclaredType06] =
    Json.format[CustomsOfficeOfTransitDeclaredType06]
  ...
  implicit lazy val holderOfTheTransitProcedureType23Format: OFormat[HolderOfTheTransitProcedureType23] = Json.format[HolderOfTheTransitProcedureType23]
  ...
  implicit lazy val consignmentType23Format: OFormat[ConsignmentType23]                                 = Json.format[ConsignmentType23]
  implicit lazy val consignmentType28Format: OFormat[ConsignmentType28]                                 = Json.format[ConsignmentType28]
